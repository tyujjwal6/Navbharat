...
// StatCard component - the data-attribute is no longer needed but does no harm.
...
export default function RealEstatePage() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // --- 1. Entrance Animations (run once on load) ---
      ...
      // --- 2. Text Slide-Up Reveal Animation (SCRUBBED) ---
      ...
      // --- 3. Statistics Section Animations (SCRUBBED) ---
      ...
      // The number counting animation block has been removed.

      // --- 4. "Building the Future" Section Animations ---
